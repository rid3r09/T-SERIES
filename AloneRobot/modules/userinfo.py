...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' \n[<a href="https://t.me/DOSTO_KI_M3HFIL">ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴋɴᴏᴡ ᴡʜᴀᴛ ɪs ᴅɪsᴀsᴛᴇʀ ʟᴇᴠᴇʟs.</a>]'.format(
            bot.username
        )
            ...
            message.reply_document(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "🤭 𝐌εℓε 𝐌αℓιк 🤭", url="https://t.me/NOOBS_ALWAYS_OP"
                            ),
                            InlineKeyboardButton(
                                "💘 𝐆υℓυρ 💘", url="https://t.me/DOSTO_KI_M3HFIL"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
                                text="🥺 𝐀∂∂  𝐊αℓℓσ  𝐍α  𝐁αвч 🥺",
                                url=f"https://t.me/T_S3RIES_BOT?startgroup=true",
                            ),
                        ],
                    ]
                ),
